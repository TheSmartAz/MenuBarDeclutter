...
12. Export diagnostics as JSON and run `scripts/qa_second_bar_activation_matrix.sh` to generate rows.
13. Record reviewed rows in `docs/testing/pro-second-bar-direct-activation-matrix.md`.
