...
- Canonical app build after the compact fallback icons update: PASS, `xcodebuild -scheme MenuBarDeclutter -destination 'platform=macOS' build -quiet` exited 0 with only the expected multiple-destination warning.
