...
- 2026-06-29 installed-app sweep:
  ...
  preflight, and read-only Private Access, Groups, Hotkeys, Automation, and
  Import / Export UI smoke. The stale `/Applications` app copy found during the
  run was replaced with the fresh Release artifact and re-verified.
