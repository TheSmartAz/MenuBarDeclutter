...
Historical snapshot: this file records the end-of-phase state for Phase 1. Later progress files, `docs/project-summary.md`, and release docs supersede old scheme names, test counts, defaults, and deferred-scope notes.
