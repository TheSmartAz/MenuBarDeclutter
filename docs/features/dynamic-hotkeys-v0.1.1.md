...
- Bindings for every possible command target, including all Basic visibility actions, Find Icon, item-specific panels, open owning app, protected command, and experimental activation.
