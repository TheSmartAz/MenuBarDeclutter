...
floating_panel_surfaces=(
  ...
  "panel|34-compact-second-bar-accessibility-required|Compact Second Bar - Accessibility Required|optional|--ui-testing-show-compact-second-bar --ui-testing-pro-discovery-enabled --ui-testing-accessibility-granted --ui-testing-accessibility-revoked-after-launch --ui-testing-accurate-icons-enabled --ui-testing-screen-capture-granted --ui-testing-second-bar-primary-click-enabled|Second Bar Compact Strip"
  "panel|35-compact-second-bar-accurate-icons-required|Compact Second Bar - Accurate Icons Required|optional|--ui-testing-show-compact-second-bar --ui-testing-pro-discovery-enabled --ui-testing-accessibility-granted --ui-testing-screen-capture-granted --ui-testing-second-bar-primary-click-enabled|Second Bar Compact Strip"
  "panel|36-compact-second-bar-screen-recording-required|Compact Second Bar - Screen Recording Required|optional|--ui-testing-show-compact-second-bar --ui-testing-pro-discovery-enabled --ui-testing-accessibility-granted --ui-testing-accurate-icons-enabled --ui-testing-second-bar-primary-click-enabled|Second Bar Compact Strip"
)
